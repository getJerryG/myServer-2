...
describe("UserService Get Session Key Test", () => {
    // 测试数据
    ...
    it("should get session_key via UserService", async () => {
        const sessionData = await UserService.getSession_key(createdUser.userId);
